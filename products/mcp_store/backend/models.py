...
InstallSource = Literal["posthog", "posthog-code"]
INSTALL_SOURCE_CHOICES = [("posthog", "posthog"), ("posthog-code", "posthog-code")]
...
class MCPOAuthState(CreatedMetaFields, UpdatedMetaFields, UUIDModel):
    ...
    posthog_code_callback_url = models.TextField(blank=True, default="")
