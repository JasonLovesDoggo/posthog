...
from posthog.hogql_queries.ai.ai_table_resolver import is_within_ai_events_ttl, validate_ai_event_names
...
class AiEventsQueryRunner(QueryRunner):
    ...
    def _should_use_ai_events_table(self) -> bool:
        ...
        return is_within_ai_events_ttl(date_from, datetime.now(tz=date_from.tzinfo))
