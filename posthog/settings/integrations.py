...
SLACK_POSTHOG_CODE_CLIENT_SECRET = get_from_env("SLACK_POSTHOG_CODE_CLIENT_SECRET", get_from_env("SLACK_TWIG_CLIENT_SECRET", ""))
SLACK_POSTHOG_CODE_SIGNING_SECRET = get_from_env("SLACK_POSTHOG_CODE_SIGNING_SECRET", get_from_env("SLACK_TWIG_SIGNING_SECRET", ""))
